    ...
    return (
        <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">
            ...
            <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
                ...
                <a className="flex gap-2 items-center text-gray-600 m-auto text-sm md:m-0 bg-white px-6 py-3 rounded-full hover:scale-105 transition-all duration-300" href="">Book Appointment <img className="w-3" src={f_assets.arrow_icon} alt="" /></a>
            </div>
            {/* right side */}
